/*
QUESTION: Comparing two numbers written in index form like 2^11 and 3^7 is not difficult, as any calculator would confirm that 2^11 = 2048 < 3^7 = 2187.
...
let exponents = fs.readFileSync(require('path').join(__dirname, '../../data/p099_base_exp.txt'), 'utf8')
    .trim()
    .split('\n')
    .map(line => line
        .split(',')
