/* QUESTION: Three distinct points are plotted at random on a Cartesian plane, for which -1000 ≤ x, y ≤ 1000, such that a triangle is formed.
...
function containsOrigin(coordinates) {
    let A = getArea(coordinates[0], coordinates[1], coordinates[2], coordinates[3], coordinates[4], coordinates[5]);
    let A1 = getArea(0, 0, coordinates[2], coordinates[3], coordinates[4], coordinates[5]);
    let A2 = getArea(coordinates[0], coordinates[1], 0, 0, coordinates[4], coordinates[5]);
    let A3 = getArea(coordinates[0], coordinates[1], coordinates[2], coordinates[3], 0, 0);
...
for (let i = 0; i < triangles.length; i++) {
    ...
    if (check != 6 && check != -6) { //not all negative or positive (so (0, 0) can be present)
