//Apply number operations on strings/arrays manually

//Add: Takes two strings of numbers and returns a new string which is their sum
function add(a, b) {

    //Making sure that both inputs are strings
...
function multiply(a, b) {
    ...
    //Removing starting zeros if they exist (Eg. 00012 x 003 = 36, not 0000036)
    while (product[0] == '0') {
